    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-slate-500 text-sm sm:text-base">Manage your WhatsApp messaging campaigns</p>
        </div>
      ...
      <Card>
        ...
        <CardContent className="p-0">
          ...
          <div className="md:hidden flex flex-col gap-4 p-2">
            {campaigns.map((campaign) => (
              <div key={campaign.id} className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm flex flex-col gap-3">
                <div className="flex justify-between items-center">
                  <Link to={`/dashboard/campaigns/${campaign.id}`} className="font-medium text-base hover:underline">
                    {campaign.name}
                  </Link>
                  <Dropdown>
                    <DropdownTrigger onClick={() => setOpenMenuId(campaign.id === openMenuId ? null : campaign.id)}>
                ...
                <div>
                  <span className="text-xs font-medium text-slate-600">Progress: {campaign.progress}</span>
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-2 text-xs text-slate-600">
                  ...
                  <div>
                    <span className="font-semibold">Account:</span> {campaign.account}
                  </div>
                  <div>
                    <span className="font-semibold">Group:</span> {campaign.group}
                  </div>
                </div>
              </div>
            ))}
